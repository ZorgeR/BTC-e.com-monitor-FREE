package com.zlab.btcmonitorfree.achart;
/* ===========================================================
...
public class CandleStickChartDemo03View extends DemoView {
    ...
    public CandleStickChartDemo03View(Context context, String Title) {
        super(context);
        title=Title;
    ...
    private static AFreeChart createChart() {
        ...
        // declare colors
        //int deepRed = R.color.holo_red_dark;
        PaintType black = new SolidColor(Color.WHITE);
        PaintType blue = new SolidColor(0xFF16a70d);
        PaintType red = new SolidColor(0xFFB70000);
        PaintType yellow = new SolidColor(0xFFFF00FF);
        PaintType darkGreen = new SolidColor(0xFFAAAAAA);
        PaintType white = new SolidColor(Color.BLACK);
        //black = white;
        //yellow = darkGreen;
